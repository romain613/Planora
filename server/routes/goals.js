...
import { extractCustomFieldsArray, enrichContactCustomFields } from '../services/leadImportEngine.js';
  ...
  for (const env of envelopes) {
    ...
    for (const lead of leads) {
      ...
      if (existingContact) {
        ...
        // V1.10.5 P4 — enrichissement Option A inline (goals reward)
        try { enrichContactCustomFields(contactId, lead.data_json, null); }
        catch (e) { console.error('[ENRICH GOALS]', e.message); }
      } else {
        ...
        // V1.10.5 P2 — propage colonnes Sheet non-standards vers contacts.custom_fields_json
        ...
        insert('contacts', {
          ...
          source: 'goal_reward', envelopeId: env.id || '',
